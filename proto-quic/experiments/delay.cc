...
int main() {
  ...
  cout << "Mean delay: " << mean_delay /1000.0<<  endl;
  cout << "Median delay: " << delays[count_all/2] /1000.0<< endl;
  cout << "90-th percentile: " << delays[count_all * 9 / 10] << " " << delays[count_all * 9 / 10] /1000.0<< endl;
  cout << "99-th percentile: " << delays[count_all * 99/ 100] << " " << delays[count_all * 99 / 100] /1000.0<< endl;
  cout << "Max delay: " << delays.back() /1000.0<< endl;
  return 0;
}

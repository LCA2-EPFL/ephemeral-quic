...
def createNetwork():
	...
	bwg = 0.5#000 #1000 #in Mbps
	bwbn = 0.5#000 #1000 #25 #in Mbps
	...
	ri.cmd('ip route add default via 10.12.0.10')
       ...
       # hu.cmd('./client.sh &')
        hu.cmd('xterm -xrm \'XTerm.vt100.allowTitleOps: false\' -T hu -e \'sleep 10; sudo ./client.sh > output-client.txt\' &')
       # hu.cmd('xterm -xrm \'XTerm.vt100.allowTitleOps: false\' -T hu -e \'python3 udp_client.py | tee udp-output-client.txt \' &')
        ...
        ht.cmd('xterm -xrm \'XTerm.vt100.allowTitleOps: false\' -T ht -e \'sleep 60; sudo ./tcpclient 10.20.0.1 6666 > tcp-output-client.txt\' &')
